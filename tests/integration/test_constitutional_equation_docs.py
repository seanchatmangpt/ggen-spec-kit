"""Constitutional equation test for docs"""
...
def test_rdf_specification_exists() -> None:
    ...
    assert any(str(r[0]).lower() == "docs" for r in results)
...
def test_cli_module_importable() -> None:
    ...
    from specify_cli.commands import docs
...
def test_ops_module_importable() -> None:
    ...
    sys.path.insert(0, "src")
    from specify_cli.ops import docs
...
def test_runtime_module_importable() -> None:
    ...
    sys.path.insert(0, "src")
    from specify_cli.runtime import docs
