"""Constitutional equation test for lint"""
import hashlib
...
def test_rdf_specification_exists() -> None:
    ...
    assert any(str(r[0]).lower() == "lint" for r in results)
...
def test_cli_module_importable() -> None:
    ...
    from specify_cli.commands import lint
    assert lint.app is not None
...
def test_ops_module_importable() -> None:
    ...
    import sys
    sys.path.insert(0, "src")
    from specify_cli.ops import lint
